...
import { FriendsUncheckedUpdateManyWithoutUsersInput } from '../friends/friends-unchecked-update-many-without-users.input';
import { DateTimeFieldUpdateOperationsInput } from '../prisma/date-time-field-update-operations.input';

@InputType()
export class UserUncheckedUpdateWithoutFriendUserFriendsInput {
    ...
    @Field(() => FriendsUncheckedUpdateManyWithoutUsersInput, {nullable:true})
    userFriends?: FriendsUncheckedUpdateManyWithoutUsersInput;

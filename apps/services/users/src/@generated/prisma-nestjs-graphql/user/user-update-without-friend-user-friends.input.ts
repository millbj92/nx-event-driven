...
import { FriendsUpdateManyWithoutUsersInput } from '../friends/friends-update-many-without-users.input';
import { DateTimeFieldUpdateOperationsInput } from '../prisma/date-time-field-update-operations.input';

@InputType()
export class UserUpdateWithoutFriendUserFriendsInput {
    ...
    @Field(() => FriendsUpdateManyWithoutUsersInput, {nullable:true})
    userFriends?: FriendsUpdateManyWithoutUsersInput;

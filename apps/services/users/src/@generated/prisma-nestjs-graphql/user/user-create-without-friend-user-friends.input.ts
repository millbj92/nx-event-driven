...
import { FriendsCreateNestedManyWithoutUsersInput } from '../friends/friends-create-nested-many-without-users.input';

@InputType()
export class UserCreateWithoutFriendUserFriendsInput {
    ...
    @Field(() => FriendsCreateNestedManyWithoutUsersInput, {nullable:true})
    userFriends?: FriendsCreateNestedManyWithoutUsersInput;

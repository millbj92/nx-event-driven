...
import { AddressUncheckedUpdateOneWithoutClaimsInput } from '../address/address-unchecked-update-one-without-claims.input';

@InputType()
export class ClaimsUncheckedUpdateWithoutUserInput {
    ...
    @Field(() => AddressUncheckedUpdateOneWithoutClaimsInput, {nullable:true})
    address?: AddressUncheckedUpdateOneWithoutClaimsInput;
}

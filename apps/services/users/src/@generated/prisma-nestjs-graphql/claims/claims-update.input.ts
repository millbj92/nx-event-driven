...
import { UserUpdateOneWithoutClaimsInput } from '../user/user-update-one-without-claims.input';
import { NullableStringFieldUpdateOperationsInput } from '../prisma/nullable-string-field-update-operations.input';
import { NullableDateTimeFieldUpdateOperationsInput } from '../prisma/nullable-date-time-field-update-operations.input';
import { BoolFieldUpdateOperationsInput } from '../prisma/bool-field-update-operations.input';
import { DateTimeFieldUpdateOperationsInput } from '../prisma/date-time-field-update-operations.input';
import { AddressUpdateOneWithoutClaimsInput } from '../address/address-update-one-without-claims.input';

@InputType()
export class ClaimsUpdateInput {

    @Field(() => StringFieldUpdateOperationsInput, {nullable:true})
    id?: StringFieldUpdateOperationsInput;

    @Field(() => UserUpdateOneWithoutClaimsInput, {nullable:true})
    user?: UserUpdateOneWithoutClaimsInput;
    ...
    @Field(() => AddressUpdateOneWithoutClaimsInput, {nullable:true})
    address?: AddressUpdateOneWithoutClaimsInput;
}

...
import { MessageUncheckedUpdateManyWithoutMessageThreadInput } from '../message/message-unchecked-update-many-without-message-thread.input';
import { DateTimeFieldUpdateOperationsInput } from '../prisma/date-time-field-update-operations.input';

@InputType()
export class MessageThreadUncheckedUpdateInput {
    ...
    @Field(() => MessageUncheckedUpdateManyWithoutMessageThreadInput, {nullable:true})
    messages?: MessageUncheckedUpdateManyWithoutMessageThreadInput;
